...
function AboutMe() {
    return (
        <div className='aboutMe'>
            ...
            <LightPanel addedClasses='aboutMe-container'>
                <div className='aboutMe-text dropFont'>
                    ...
                    <p>There are 3 top tips for completing an escape room; search, speak, simple. It turns out thatthey apply to my work and coding too. Find the relevant tools and knowledge, communicate withthe team, look for the simplest solution.</p>

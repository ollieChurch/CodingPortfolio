...
function KidnappedProfessorLaunch() {
    return (
        <ArticleContainer article='kidnappedprofessorlaunch'>
            ...
            <p>If you fancy yourself as detective you can purchase both Maxwell Mysteries games from <a href='https://paradoxparlours.com/escape-rooms/online' target='_blank' rel='norefferer'>Paradox Parlours Escape Rooms</a>. You can also try out a short demo level at <a href='' target='_blank' rel='norefferer'>mysteries-demo.co.uk</a></p>
        </ArticleContainer>
    )
}
